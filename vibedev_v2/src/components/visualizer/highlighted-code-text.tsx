...
import { getUserWorkspaces } from "@/app/actions/get-user-workspaces"; // 🚀 Dynamic Action Hook Link
import { 
  Sparkles, Loader2, Network, X, FileCode, MessageSquare, ShieldAlert, Send, 
  Maximize2, Minimize2, Clock, Play, Pause, UserCheck, Building2, Layers, ChevronDown 
} from "lucide-react";
...
export function HighlightedCodeText({ code }: { code: string }) {
  if (!code) return null;
